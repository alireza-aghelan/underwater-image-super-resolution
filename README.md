...
In this project, we fine-tune the pre-trained Real-ESRGAN model for underwater image super-resolution. We use USR-248 dataset for fine-tuning model. The proposed model generates more realistic and higher-quality images compared to the original Real-ESRGAN model.
